...
func (a *app) routes() http.Handler {
	...
	mux.Handle("GET /timeentry", htmxMiddle.Then(handlers.HandleTimeEntry(a.logger, a.epilogue, a.sessionManager)))
	mux.Handle("GET /timeentry/newtime", htmxMiddle.Then(handlers.HandleNewTimeCard(a.logger, a.epilogue, a.sessionManager)))
	...
	mux.Handle("GET /timeentry/timecard/{id}", htmxMiddle.Then(handlers.HandleGetTimeCard(a.logger, a.epilogue, a.sessionManager)))
	mux.Handle("PUT /timeentry/timecard/{id}", htmxMiddle.Then(handlers.HandlePutTimeCard(a.logger, a.epilogue, a.sessionManager)))
	mux.Handle("DELETE /timeentry/timecard/{id}", htmxMiddle.Then(handlers.HandleDeleteTimeCard(a.logger, a.epilogue, a.sessionManager)))
	...
	mux.Handle("GET /tc/employeeselect", htmxMiddle.Then(handlers.HandleEmployeeSelect(a.logger, a.epilogue)))
	mux.Handle("GET /tc/classes", htmxMiddle.Then(handlers.HandleClassesSelect(a.logger, a.epilogue)))
	mux.Handle("GET /tc/earncode", htmxMiddle.Then(handlers.HandleEarnCodeSelect(a.logger, a.epilogue)))
	mux.Handle("GET /tc/addemployeerow", htmxMiddle.Then(handlers.HandleAddEmployeeRow(a.logger)))
	mux.Handle("GET /tc/equipmentselect", htmxMiddle.Then(handlers.HandleEquipmentSelect(a.logger, a.epilogue)))
